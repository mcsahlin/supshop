...
function populateCartData(cartItem:Cart) {
    ...
    let cartProductPrice = createHtmlElementWithClassAndId("div", "CartProductPrice", cartItem.item.id) as HTMLElement;
    let cartProductQuantity = createHtml("input", "CartProductQuantity") as HTMLElement;
    ...
    minusButton.addEventListener("click", (e) => {
        ...
        let txtValue = btnBox.querySelector(".CartProductQuantity") as HTMLInputElement
